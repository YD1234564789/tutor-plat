...
const teacherController = {
  ...
  myProfile: (req, res, next) => {
    teacherServices.getTeachers(req, (err, data) => err ? next(err) : res.render('teachers/myProfile', data))
  },
  getTeacher: (req, res, next) => {
    teacherServices.getTeacher(req, (err, data) => err ? next(err) : res.render('teachers/teacherProfile', data))
  },
  editPage: (req, res) => {
    teacherServices.getTeachers(req, (err, data) => err ? next(err) : res.render('teachers/edit', data))
  },
